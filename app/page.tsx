      ...
      <div className={`${montserrat.className}`}>
        ...
        <AnimatedSection type="fade" direction="up" delay={0.2} className="relative px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-28 min-h-screen flex items-center hero_gradient">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 px-4 sm:px-6 w-full">
            {/* Main Heading */}
            <h1 className="text-[#1e3a8a] mx-auto text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-semibold mb-4 sm:mb-6 leading-tight">
        ...
        <AnimatedSection
          ...
          direction="up"
          delay={0.2}
          className="relative z-10 mx-auto w-full sm:max-w-[90%] md:max-w-[85%] lg:max-w-[80%] xl:max-w-[70%] px-4 sm:px-6 lg:px-8 -mt-30 sm:-mt-16 md:-mt-20 lg:-mt-28 mb-5 sm:mb-10 md:mb-12"
        >

  ...
  return (
    <main>
      ...
      <div className={`${montserrat.className}`}>
        ...
        {/* How it works */}
        <section className="px-4 sm:px-6 lg:px-8 py-20 bg-gradient-to-b from-white to-gray-50">
          <div className="max-w-6xl mx-auto">
            {/* Section Header */}
            <div className="mb-16 flex justify-between">
              <h2 className="text-3xl text-[#059669] mb-4 font-semibold">How it works</h2>
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-20 bg-[#1e3a8a] text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-4">Be Tax Ready for 2026</h2>
            ...
            <Button className="bg-white hover:bg-gray-100 text-[#1e3a8a] font-semibold px-8 py-6 text-base">
